...
![Гистограмма и KDE](plots/hist_kde_n20.png)
...
![Сходимость мат. ожидания и дисперсии](plots/convergence.png)
...
![Плотность распределения](plots/density.png)

#### График функции распределения

![Функция распределения](plots/cdf.png)
